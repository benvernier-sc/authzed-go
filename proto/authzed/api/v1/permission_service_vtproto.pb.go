...
func (m *RelationshipUpdateStatus) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *RelationshipUpdateStatus) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RelationshipUpdateStatus)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *RelationshipUpdateStatus) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RelationshipUpdateStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RelationshipUpdateStatus) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RelationshipUpdateStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RelationshipUpdateStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
