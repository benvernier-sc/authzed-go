...
// Validate checks the field values on RelationshipUpdateStatus with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RelationshipUpdateStatus) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RelationshipUpdateStatus with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RelationshipUpdateStatusMultiError, or nil if none found.
func (m *RelationshipUpdateStatus) ValidateAll() error {
	return m.validate(true)
}

func (m *RelationshipUpdateStatus) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RelationshipUpdateStatusMultiError(errors)
	}

	return nil
}

// RelationshipUpdateStatusMultiError is an error wrapping multiple validation
// errors returned by RelationshipUpdateStatus.ValidateAll() if the designated
// constraints aren't met.
type RelationshipUpdateStatusMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RelationshipUpdateStatusMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RelationshipUpdateStatusMultiError) AllErrors() []error { return m }

// RelationshipUpdateStatusValidationError is the validation error returned by
// RelationshipUpdateStatus.Validate if the designated constraints aren't met.
type RelationshipUpdateStatusValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RelationshipUpdateStatusValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RelationshipUpdateStatusValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RelationshipUpdateStatusValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RelationshipUpdateStatusValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RelationshipUpdateStatusValidationError) ErrorName() string {
	return "RelationshipUpdateStatusValidationError"
}

// Error satisfies the builtin error interface
func (e RelationshipUpdateStatusValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRelationshipUpdateStatus.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RelationshipUpdateStatusValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RelationshipUpdateStatusValidationError{}
